...
use CGI::WPM::MultiPage 0.44;
use CGI::WPM::Static 0.44;
use CGI::WPM::MailForm 0.44;
use CGI::WPM::GuestBook 0.44;
use CGI::WPM::SegTextDoc 0.44;
use CGI::WPM::Redirect 0.44;
use CGI::WPM::Usage 0.44;
$loaded = 1;
print "ok 1\n";
use strict;
