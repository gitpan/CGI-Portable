...
CGI::WPM::GuestBook - Demo of CGI::Portable that implements a complete guest 
...
CGI::WPM::GuestBook has separate modes for signing the guest book and viewing 
...
sub read_guest_book {
	...
	my @message_list = $self->_fetch_all_records( $filename, 1 );
